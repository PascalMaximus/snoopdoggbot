...
def start(update: Update, context: CallbackContext) -> None:
    ...
    if user_says == "sourcecode":
        update.message.reply_text("[SourceCode](https://github.com/pascalmaximus/snoopdoggbot)\nBrought to you by @botivity", disable_web_page_preview = True ,parse_mode= ParseMode.MARKDOWN)
    else:
