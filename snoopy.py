...
def start(update: Update, context: CallbackContext) -> None:
    keyboard = [
        [   InlineKeyboardButton("Source code", url= "https://github.com/pascalmaximus/snoopdoggbot"),
...
@send_action(ChatAction.TYPING)
def source_code(update: Update, context: CallbackContext) -> None:
  update.message.reply_text("[Source code](https://github.com/pascalmaximus/snoopdoggbot)\nEnjoy :)", parse_mode= ParseMode.MARKDOWN , disable_web_page_preview=True)
...
def main() -> None:
    ...
    dp.add_handler(CommandHandler("sourcecode", source_code))
